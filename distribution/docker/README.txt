...
6. Откройте admin-credentials.txt и войдите готовым администратором.
7. После первого успешного входа сохраните пароль в защищенном месте и удалите admin-credentials.txt.

При чистой установке автоматически создаются первоначальные тарифы, регулярные услуги и нерегулярные платежи.
Проверьте суммы и даты действия в разделе «Тарифы и сборы» до начала реального учета.
...
- Не отправляйте admin-credentials.txt посторонним; удалите его после безопасного сохранения пароля.
