...
builder.Services.AddScoped<IGarageCreationService, GarageCreationService>();
...
builder.Services.AddScoped<ISupplierServiceRepository, EfSupplierServiceRepository>();
builder.Services.AddScoped<ISupplierServiceCatalog, SupplierServiceCatalog>();
...
builder.Services.AddScoped<IExpenseBatchStaffDebtQuery, EfExpenseBatchStaffDebtQuery>();
builder.Services.AddScoped<IExpenseBatchPreviewService, ExpenseBatchPreviewService>();
builder.Services.AddScoped<IExpenseBatchTransactionRunner, EfExpenseBatchTransactionRunner>();
builder.Services.AddScoped<IExpensePaymentBatchRepository, EfExpensePaymentBatchRepository>();
builder.Services.AddScoped<IExpenseBatchPaymentService, ExpenseBatchPaymentService>();
