...
public interface IFinanceService
{
    ...
    Task<FinanceResult<GarageFullPaymentQuoteDto>> GetGarageFullPaymentQuoteAsync(Guid garageId, CancellationToken cancellationToken);
    ...
    Task<FinanceResult<GarageIncomeWorksheetDto>> CalculateGarageIncomeWorksheetAsync(
        Guid garageId,
    ...
    Task<FinanceResult<FinancialOperationDto>> UpdateStaffPaymentAsync(Guid operationId, UpdateStaffPaymentRequest request, Guid? actorUserId, CancellationToken cancellationToken);
    ...
    Task<FinanceResult<MeterReadingDto>> CorrectHistoricalMeterReadingAsync(Guid meterReadingId, CorrectHistoricalMeterReadingRequest request, Guid? actorUserId, CancellationToken cancellationToken);
