...
public interface IChargeServiceSettingRepository
{
    ...
    Task<Tariff?> FindLinkedTariffAsync(Guid serviceId, Guid tariffId, CancellationToken cancellationToken);
...
public sealed record ChargeServiceTariffScheduleData(
    bool ServiceExists,
