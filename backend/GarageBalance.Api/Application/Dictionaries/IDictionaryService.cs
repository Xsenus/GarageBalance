...
public interface IDictionaryService
{
    ...
    Task<PagedResult<SupplierDto>> GetSuppliersPageAsync(Guid? groupId, string? search, int? offset, int? limit, string? sortBy, string? sortDirection, CancellationToken cancellationToken, bool includeArchived = false);
    ...
    Task<IReadOnlyList<StaffDepartmentSalaryFundDto>> GetStaffDepartmentSalaryFundAsync(CancellationToken cancellationToken);
    ...
    Task<PagedResult<StaffMemberDto>> GetStaffMembersPageAsync(Guid? departmentId, string? search, int? offset, int? limit, string? sortBy, string? sortDirection, CancellationToken cancellationToken, bool includeArchived = false);
    ...
    Task<IReadOnlyList<ChargeServiceSettingDto>> GetChargeServiceSettingsAsync(string? search, CancellationToken cancellationToken, int? limit = null, bool includeArchived = false, bool? isRegular = null, bool? isMetered = null);
