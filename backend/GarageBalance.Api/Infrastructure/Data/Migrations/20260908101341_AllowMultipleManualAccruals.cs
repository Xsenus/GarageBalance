...
{
    /// <inheritdoc />
    public partial class AllowMultipleManualAccruals : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "\"IsCanceled\" = false AND \"Source\" = 'regular'");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "\"IsCanceled\" = false AND \"Source\" = 'regular' AND \"IrregularPaymentId\" IS NULL AND \"FeeCampaignId\" IS NULL AND \"Basis\" IS NULL");
        }
