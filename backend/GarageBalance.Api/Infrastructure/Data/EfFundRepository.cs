        ...
        CancellationToken cancellationToken)
    {
        var rows = await query
            ...
            .Select(operation => new
            {
                ...
                IsFundArchived = operation.Fund.IsArchived,
        ...
        return rows.Select(row => new FundOperation
        {
            Id = row.Id,
            FundId = row.FundId,
            Fund = new Fund { Id = row.FundId, Name = row.FundName, IsArchived = row.IsFundArchived },
        ...
        CancellationToken cancellationToken)
    {
        ...
        var pageRows = query
            ...
            .Select(operation => new
            {
                ...
                IsFundArchived = (bool?)operation.Fund.IsArchived,
        ...
        var items = rows
            ...
            .Select(row => new FundOperation
            {
                ...
                Fund = new Fund { Id = row.FundId.Value, Name = row.FundName!, IsArchived = row.IsFundArchived!.Value },
                SourceFinancialOperationId = row.SourceFinancialOperationId,
                OperationKind = row.OperationKind!,
