...
public sealed class FundsControllerTests
{
    ...
    {
        var reconciliation = new FundReconciliationDto(1000m, 700m, 250m, 300m, 50m, false);
    ...
    [Theory]
    [InlineData("fund_negative_balance", 409)]
    [InlineData("fund_not_found", 404)]
    ...
    private sealed class FakeFundService : IFundService
    {
        ...
        public FundReconciliationDto Reconciliation { get; init; } = new(0m, 0m, 0m, 0m, 0m, true);
