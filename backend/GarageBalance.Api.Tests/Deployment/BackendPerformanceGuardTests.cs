...
public sealed class BackendPerformanceGuardTests
{
    ...
    public void FinanceWorkingLists_AllUseNormalizedRequestLimit()
    {
        ...
        Assert.True(
            CountOccurrences(source, ".Take(NormalizeListLimit(request.Limit))") >= 2,
    ...
    public void FinancePageQueries_UseCountSkipAndTakeBeforeMaterialization()
    {
        ...
        Assert.True(
            CountOccurrences(source, "CountAsync(cancellationToken)") >= 2,
        ...
        Assert.True(
            CountOccurrences(source, ".Skip(normalizedOffset)") >= 2,
        ...
        Assert.True(
            CountOccurrences(source, ".ToListAsync(cancellationToken)") >= 4,
