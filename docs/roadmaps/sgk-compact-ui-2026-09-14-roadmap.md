...
- [~] Отправить актуальную `master`, дождаться успешного GitHub Actions и автодеплоя.
- [~] Выполнить smoke-приёмку опубликованного приложения и проверить отсутствие критических ошибок.
- [~] Удалить только полностью интегрированные рабочие ветки, очистить временные ресурсы и подтвердить чистое состояние репозитория.
