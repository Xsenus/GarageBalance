...
Документ фиксирует, какие данные GarageBalance считаются чувствительными, какие требуют повышенной защиты и как хранить импортные файлы/логи. Это входной контракт для будущего шифрования настроек интеграций, импорта Access, истории изменений, backup и передачи проекта.
...
- В истории изменений хранить бизнес-событие, пользователя, сущность и краткое описание, но не хранить пароли, токены, секреты, полные файлы импорта и содержимое дампов.
- CSV-экспорт истории изменений должен использовать то же masking-правило, что экранная история.
