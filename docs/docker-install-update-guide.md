...
Инструкция рассчитана на администратора, который раньше не работал с Docker. Она описывает первый запуск, безопасное обновление, хранение данных, автоматические и ручные резервные копии, проверку восстановления и удаление установки.
...
## 5. Автоматические и ручные копии
...
## 7. Проверка backup без затрагивания рабочей базы
...
## 8. Аварийное восстановление рабочей базы
...
## 9. Перезагрузка, остановка и удаление
