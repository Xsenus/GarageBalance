...
- 2026-07-15 — стоимость нерегулярной услуги в форме «Добавить услугу» перенесена в правую треть строки, выровнена вправо и показывает единый денежный формат «1 000 000.00» в примере и после редактирования.
