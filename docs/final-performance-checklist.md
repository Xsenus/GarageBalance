...
блокировок. Ручной `VACUUM` или изменение порогов допускаются только после подтверждённого
превышения, а не по одному высокому проценту у маленькой таблицы.
