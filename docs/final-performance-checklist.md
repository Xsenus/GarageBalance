...
- [x] Added `PostgreSqlIncomeReportPaymentQueryIntegrationTests.PaymentPageReusesProjectedTargetsAndLoadsTotalsPageAndDebtInThreeCommands`. It verifies exact totals, documents, chronological debts and exactly three PostgreSQL commands without a visible-payment identifier reread.
