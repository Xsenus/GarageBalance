...
| Настройки | Вертикальная внутренняя навигация с role-based tabs, форма смены пароля | Раздел открывается из боковой навигации администратора и не дублируется среди плиток главного меню; вкладка «Безопасность» доступна внутри раздела, вкладка интеграций и ее запросы временно отключены общей настройкой интерфейса |
