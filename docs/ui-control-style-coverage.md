...
| Настройки | Вертикальная внутренняя навигация с role-based tabs, форма смены пароля | Вкладка «Безопасность» доступна всем вошедшим пользователям; вкладка интеграций и ее запросы временно отключены общей настройкой интерфейса |
