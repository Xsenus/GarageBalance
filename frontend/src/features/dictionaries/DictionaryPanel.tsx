    ...
    if (section === 'garages') {
      return (
        <>
          ...
          {dictionaryField('garageStartingBalance', <MoneyInput aria-label={fieldMeta('garageStartingBalance').ariaLabel} value={garageForm.startingBalance} onValueChange={(startingBalance) => setGarageForm({ ...garageForm, startingBalance })} />)}
          <div className="inline-fields">
    ...
    if (section === 'suppliers') {
      return (
        <>
          ...
          {dictionaryField('supplierStartingBalance', <MoneyInput aria-label={fieldMeta('supplierStartingBalance').ariaLabel} value={supplierForm.startingBalance} onValueChange={(startingBalance) => setSupplierForm({ ...supplierForm, startingBalance })} />)}
