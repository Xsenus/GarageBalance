...
describe('App', () => {
  ...
  it('shows contractors tabs and section dialogs without local history access', async () => {
    ...
    await user.click(within(garageRow as HTMLElement).getByRole('button', { name: 'Вернуть' }))
    ...
    await user.click(within(restoreGarageDialog).getByRole('button', { name: 'Вернуть запись' }))
