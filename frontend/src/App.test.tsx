...
describe('App', () => {
  ...
  it('pays opening debt through full payment when worksheet has no service rows', async () => {
    ...
    expect(within(fullPaymentDialog).getByLabelText('Сумма полной оплаты')).toHaveValue('900.00')
  ...
  it('moves garage debt to the next month and saves the transfer in form history', async () => {
    ...
    expect(within(transferDialog).getByLabelText('Сумма переноса задолженности')).toHaveValue('1 700.00')
