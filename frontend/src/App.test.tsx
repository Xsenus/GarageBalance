...
describe('App', () => {
  ...
  it('opens financial reports for suppliers and staff from contractors tables', async () => {
    ...
    const reportPeriodFrom = within(supplierReport).getByLabelText('Начало периода финансового отчета контрагента')
    ...
    for (const row of within(supplierReportTable).getAllByRole('row').slice(1)) {
      ...
      expect(cells[4]).toHaveClass('contractor-financial-report__amount')
