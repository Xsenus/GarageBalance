...
describe('App', () => {
  ...
  it('shows payments prototype and opens payment form modals', async () => {
    ...
    expect(within(garageActions as HTMLElement).getByRole('button', { name: 'Сформировать начисления' })).toBeInTheDocument()
    expect(within(garageActions as HTMLElement).getByRole('button', { name: 'Перенести задолженность' })).toBeInTheDocument()
    expect(within(garageActions as HTMLElement).getByRole('button', { name: 'Полная оплата' })).toBeInTheDocument()
