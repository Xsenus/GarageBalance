...
describe('reportsApi', () => {
  ...
  it('loads paged cash, bank and fund reports with other dedicated filtered endpoints', async () => {
    ...
    expect(fetchMock).toHaveBeenNthCalledWith(1, '/api/reports/cash-payments?dateFrom=2026-06-01&dateTo=2026-06-30&search=%D1%87%D0%B5%D0%BA&offset=20&limit=20', getRequest())
    expect(fetchMock).toHaveBeenNthCalledWith(2, '/api/reports/bank-deposits?dateFrom=2026-06-01&dateTo=2026-06-30&search=%D0%B1%D0%B0%D0%BD%D0%BA&offset=20&limit=20', getRequest())
