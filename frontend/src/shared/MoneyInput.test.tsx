...
describe('MoneyInput', () => {
  ...
  it('allows a form to provide a more descriptive empty-value hint', () => {
    render(<MoneyTextInput aria-label="Стоимость" placeholder="1 000 000.00" value="" onValueChange={() => undefined} />)

    expect(screen.getByLabelText('Стоимость')).toHaveAttribute('placeholder', '1 000 000.00')
  })
