...
export function buildReportFileName(type: 'consolidated' | 'income' | 'expense' | 'cash-payments' | 'bank-deposits', dateFrom: string, dateTo: string, extension: 'xlsx' | 'pdf'): string {
