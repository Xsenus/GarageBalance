...
В справочниках есть быстрый поиск гаражей по номеру или ФИО владельца и поиск поставщиков по названию, ИНН или контактному лицу. Оба поиска обращаются к backend-фильтрам и показывают счетчик найденных записей.
