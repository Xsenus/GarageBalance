...
Списки справочников показывают первые 5 записей и выводят счетчик вида `Показано 5 из N записей`, если в разделе есть дополнительные элементы. Так оператор видит, что список обрезан для компактности, а не считает данные потерянными.
