...
При редактировании тарифа интерфейс предупреждает о несохраненных изменениях: если поля изменены и пользователь нажимает "Отменить", система просит подтвердить сброс. Без подтверждения черновик остается в форме, после подтверждения форма возвращается в режим добавления.
